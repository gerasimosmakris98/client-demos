    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black text-white">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 border border-lime-500/30 rounded-full bg-lime-500/10 text-lime-400 font-mono text-[10px] md:text-sm tracking-widest uppercase mb-8 backdrop-blur-md">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 px-6">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full md:w-auto bg-lime-500 text-black px-10 py-4 rounded-full font-black uppercase tracking-wider hover:bg-lime-400 transition-colors shadow-[0_0_20px_rgba(132,204,22,0.4)] text-sm md:text-base"
                        >
                            {t.hero.ctaPrimary}
                        </motion.button>
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-full md:w-auto px-10 py-4 rounded-full font-bold uppercase tracking-wider border border-white/20 hover:bg-white/10 transition-colors backdrop-blur-sm flex items-center justify-center gap-2 text-sm md:text-base"
                        >
                            <Dumbbell size={20} /> {t.hero.ctaSecondary}
                        </motion.button>
                    </div>
                </motion.div>
            </div>
