            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="bg-slate-900 rounded-[3rem] p-8 md:p-16 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10">
                        <span className="text-rose-400 font-bold tracking-widest uppercase text-sm">Book Online</span>
                        <h2 className="text-4xl md:text-5xl font-black text-white mt-4 mb-8">Ready for a Transformation?</h2>
                        <p className="text-slate-400 text-lg mb-12 max-w-2xl mx-auto">
                            Select your service, choose your stylist, and pick a time that works for you. It's that simple.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-2 rounded-2xl md:rounded-full border border-white/10 flex flex-col md:flex-row gap-2 max-w-3xl mx-auto">
                            <div className="flex-1 flex items-center gap-3 px-6 py-4 bg-white/5 rounded-xl md:rounded-full border border-white/5 hover:bg-white/10 transition-colors cursor-pointer text-left">
                                ...
                                <div>
                                    <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Service</p>
                                    <p className="text-white font-bold text-sm">Haircut & Style</p>
                                </div>
                            </div>
                            <div className="flex-1 flex items-center gap-3 px-6 py-4 bg-white/5 rounded-xl md:rounded-full border border-white/5 hover:bg-white/10 transition-colors cursor-pointer text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-bold text-sm">Tomorrow</p>
                                </div>
                            </div>
                            <button className="bg-rose-500 hover:bg-rose-600 text-white px-8 py-4 rounded-xl md:rounded-full font-bold transition-all shadow-lg hover:shadow-rose-500/25">
                                Book Now
                            </button>
                        </div>
                    </div>
