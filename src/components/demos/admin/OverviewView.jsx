            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-3">
                <div className="lg:col-span-3 bg-[#0e1425] p-5 md:p-6 rounded-2xl border border-white/[0.06]">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-white font-bold flex items-center gap-2"><BarChart3 size={17} className={c.text} /> {t.performance}</h3>
                ...
                <div className="lg:col-span-2 bg-[#0e1425] p-5 md:p-6 rounded-2xl border border-white/[0.06]">
                    <h3 className="text-white font-bold mb-4 text-sm flex items-center gap-2"><Clock size={15} className={c.text} /> {t.recentActivity}</h3>
                    <div className="space-y-1">
                        {(recentItems.length > 0 ? recentItems : [
                            ...
                            <div key={i} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/[0.02] transition-colors group cursor-pointer">
                                <div className={`w-2 h-2 rounded-full ${i === 0 ? 'bg-emerald-500 animate-pulse' : 'bg-slate-600'}`} />
                                <div className="flex-1 min-w-0">
                                    <p className="text-white text-xs font-bold truncate group-hover:text-emerald-400 transition-colors">{item.title}</p>
